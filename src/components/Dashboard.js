        ...
        <div className="flex items-start max-w-screen-lg mx-auto py-12">
              ...
              <div>
                ...
                <div className="px-6 leading-7">
                  <div className="pt-3 flex items-center">
                    ...
                    <p className="text-gray-800 text-sm ml-3">
                      All team Boards
                    </p>
                  </div>
          ...
          <div className="w-4/5 pl-40">
            <div className="font-bold text-xl flex items-center text-gray-900">
              ...
              <p className="ml-2">Your Team Boards</p>
            </div>
            <div className="flex mt-6">
              <div className="px-4 py-5 hover:bg-gray-400 rounded-md cursor-pointer">
                <p className="text-trello-blue">Create new board</p>
              </div>
            </div>
          </div>
        </div>
