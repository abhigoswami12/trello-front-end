...
function LandingPage() {
  return (
    <section className="bg-trello-blue font-nunito">
      <div className="max-w-screen-xl mx-auto py-4">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex-1 min-w-0">
            <svg
              className="w-32 h-132 d-block"
              width="130"
              height="40"
              viewBox="0 0 885 272"
              alt="Trello"
          ...
          <div className="mt-4 flex md:mt-0 md:ml-4">
            <span className="ml-3 shadow-sm rounded-md">
              <Link to="/login" exact>
                <button
                  type="button"
                  className="font-semibold text-lg tracking-wide inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white hover:text-gray-300 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-700 active:bg-indigo-700 transition duration-150 ease-in-out"
                >
                  Log in
                </button>
              </Link>
            ...
            <span className="shadow-sm rounded-md">
              <Link to="/signup">
                <button
                  type="button"
                  className="font-semibold text-lg tracking-wide ml-4 mr-2 inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-trello-blue bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:text-gray-800 active:bg-gray-50 transition duration-150 ease-in-out"
                >
                  Sign up
                </button>
              </Link>
